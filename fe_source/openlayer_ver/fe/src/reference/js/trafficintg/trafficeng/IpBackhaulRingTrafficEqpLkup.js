  ...
  //Grid 초기화
    	...
    	//페이지 selectbox를 변경했을 시.
         ...
         $('#'+gridId).on('dblclick', '.bodycell', function(e){
       		 ...
       		 var dataObj = null;
        	 	...
        	 	/* IP백홀 링 대표트래픽 포트 정보    	 */
        	 	popupList('IpBackhaulRingTrafficPortLkup', $('#ctx').val()+'/trafficintg/trafficeng/IpBackhaulRingTrafficPortLkup.do', 'IP백홀 링 대표트래픽 포트 정보',dataObj);
    ...
    function setGrid(page, rowPerPage) {
    	...
    	$('#rowPerPageEqpLkup').val(rowPerPage);
		 ...
		 $('#'+gridId).alopexGrid('showProgress');
		 httpRequest('tango-transmission-biz/trafficintg/trafficeng/ipBackhaulRingTrafficEqpLkup', param, 'GET', 'search');
    }
