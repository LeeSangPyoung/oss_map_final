...
$a.page(function() {
    ...
    function setGrid(page, rowPerPage) {
    	...
    	httpRequest('tango-transmission-biz/trafficintg/trafficeng/ipBackhaulTrafficCurstLkup', param, successCallbackSearch, failCallback, 'GET');
    }
    ...
    function setEventListener() {
        ...
        $('#btnExportExcel').on('click', function(e) {
    		...
    		param.excelUpload = "N";
    		param.method = "ipBackhaulTrafficCurstLkup";	// 필수. TrafficExcelBatchDAO 메소드명과 일치시키기
    		...
    		param.fileName = "IpBackhaulTrafficCurstLkup" + "_" + dayTime + "." + param.fileExtension;
    		param.excelFlag = "IpBackhaulTrafficCurstLkup";     // (2017-03-02 : HS Kim) 추가, 필수 값
    		...
    		//param.fileName = "IP백홀트래픽현황조회";
 	    	//httpRequest('tango-transmission-biz/trafficintg/trafficeng/excelcreateIpBackhaulTrafficCurstLkup', param, successCallbackExcel, failCallback, 'GET');
...
/*	function changeMdl(){
	...
	var successCallbackSearch = function(response){
		$('#'+gridId).alopexGrid('hideProgress');
		setSPGrid(gridId,response, response.ipBackhaulTrafficCurstLkup);
	}
