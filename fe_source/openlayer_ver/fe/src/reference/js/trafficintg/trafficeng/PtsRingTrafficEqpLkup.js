  ...
  //Grid 초기화
    function initGrid() {
        ...
        $('#'+gridId).alopexGrid({
    		...
    		rowOption:{inlineStyle: function(data,rowOption){
    			if(data['eqpNm'] == $('#cotEqpNmEqpLkup').val()) 
        ...
        $('#'+gridId).alopexGrid("hideCol", ['eqpId','clctDt','maxBpsDt'], 'conceal');
    	...
    	//페이지 selectbox를 변경했을 시.
         ...
         $('#'+gridId).on('dblclick', '.bodycell', function(e){
       		 ...
       		 var dataObj = null;
        	 	...
        	 	/* PTS 링 대표트래픽 포트 정보    	 */
        	 	popupList('PtsRingTrafficPortLkup', $('#ctx').val()+'/trafficintg/trafficeng/PtsRingTrafficPortLkup.do', 'PTS 링 대표트래픽 포트 정보',dataObj);
    ...
    function setGrid(page, rowPerPage) {
    	...
    	$('#rowPerPageEqpLkup').val(rowPerPage);
		 ...
		 $('#'+gridId).alopexGrid('showProgress');
		 httpRequest('tango-transmission-biz/trafficintg/trafficeng/ptsRingTrafficEqpLkup', param, 'GET', 'search');
    }
