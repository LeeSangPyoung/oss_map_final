/**
 * L2SWTrafficSimulation.js
 *
 * @author 이현우
 * @date 2016. 8. 04. 오후 05:11:00
 * @version 1.0
 */
$a.page(function() {
    ...
    function setSelectCode() {
        ...
        selectList = [ {el: '#hdofcNm', url: 'orgs/'+chrrOrgGrpCd, key: 'orgId', label: 'orgNm'}
                          ,{el: '#teamNm', url: 'teams/'+chrrOrgGrpCd, key: 'orgId', label: 'orgNm'}
   	                      ...
   	                      ,{el: '#mdlNm', url: 'modellcls', key: 'comCd', label: 'comCdNm'}
    ...
    function setGrid(page, rowPerPage) {
    	...
    	httpRequest('tango-transmission-biz/trafficintg/trafficeng/lTwoSWTrafficSimulation', param, successCallbackSearch, failCallback, 'GET');
    }
    ...
    function setEventListener() {
        ...
        $('#btnExportExcel').on('click', function(e) {
    		...
    		param.excelUpload = "N";
    		param.method = "lTwoSWTrafficSimulation";	// 필수. TrafficExcelBatchDAO 메소드명과 일치시키기
    		...
    		param.fileName = "LTwoSWTrafficSimulation" + "_" + dayTime + "." + param.fileExtension;
    		param.excelFlag = "LTwoSWTrafficSimulation";     // 필수 값
    		...
    		$('#'+gridId).alopexGrid('showProgress');
    		//param.fileName = "L2SW트래픽시뮬레이션";
 	    	//httpRequest('tango-transmission-biz/trafficintg/trafficeng/excelcreateLTwoSWTrafficSimulation', param, successCallbackExcel, failCallback, 'GET');
	...
	var successCallbackSearch = function(response){
		$('#'+gridId).alopexGrid('hideProgress');
		setSPGrid(gridId,response, response.l2SWTrafficSimulation);
	}
