    ...
    function initGrid() {
	    ...
	    $('#'+gridId).alopexGrid({
	    	...
	    	columnMapping: [{
    			...
    			key : 'avgInBpsRate', align:'right',
				title : 'INBPS사용률(%)',
				width: '110px'
			},{
    			key : 'avgOutBpsRate', align:'right',
				title : 'OUTBPS사용률(%)',
				width: '110px'
			},{
    			key : 'maxRxpwrVal', align:'right',
				title : '최대RXPOWER',
				width: '120px'
			},{
    			key : 'avgRxpwrVal', align:'right',
				title : '평균RXPOWER',
				width: '120px'
			},{
    			key : 'minRxpwrVal', align:'right',
				title : '최소RXPOWER',
				width: '120px'
			},{
    			key : 'maxTxpwrVal', align:'right',
				title : '최대TXPOWER',
				width: '120px'
			},{
    			key : 'avgTxpwrVal', align:'right',
				title : '평균TXPOWER',
				width: '120px'
			},{
    			key : 'minTxpwrVal', align:'right',
				title : '최소TXPOWER',
				width: '120px'
			}],
			message: {
...
//    	param.period = '1min';
    	...
    	httpRequest('tango-transmission-biz/trafficintg/trafficeng/mwTrafficCurstLkup', param, successCallbackSearch, failCallback, 'GET');
    }
