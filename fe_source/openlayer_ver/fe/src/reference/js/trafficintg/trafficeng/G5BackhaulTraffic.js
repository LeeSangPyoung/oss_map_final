...
//    	$('#'+gridId).alopexGrid('showProgress');
    	...
    	httpRequest('tango-transmission-biz/trafficintg/trafficeng/g5BackhaulTraffic', param, successCallbackSearch, failCallback, 'GET');
    }
    ...
    function setEventListener() {
        ...
        $('#btnExportExcel').on('click', function(e) {
    		...
    		param.excelUpload = "N";
    		param.method = "g5BackhaulTraffic";	// 필수. TrafficExcelBatchDAO 메소드명과 일치시키기
	        ...
	        param.fileName = "G5BackhaulTraffic" + "_" + dayTime + "." + param.fileExtension;
    		param.excelFlag = "G5BackhaulTraffic";
    		...
    		//param.fileName = "IP백홀대표트래픽";
 	    	//httpRequest('tango-transmission-biz/trafficintg/trafficeng/excelcreateG5BackhaulTraffic', param, successCallbackExcel, failCallback, 'GET');
...
//          $('#').on('click', function(e) {
	...
	var successCallbackSearch = function(response){
		...
		setSPGrid(gridId,response, response.g5BackhaulTraffic);
	}
