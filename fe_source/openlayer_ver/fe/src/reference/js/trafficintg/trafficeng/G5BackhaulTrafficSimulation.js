/**
 * G5BackhaulTrafficSimulation.js
 *
 * @author 이현우
...
$a.page(function() {
    ...
    function setGrid(page, rowPerPage) {
    	...
    	httpRequest('tango-transmission-biz/trafficintg/trafficeng/g5BackhaulTrafficSimulation', param, successCallbackSearch, failCallback, 'GET');
    }
    ...
    function setEventListener() {
        ...
        $('#btnExportExcel').on('click', function(e) {
    		...
    		param.excelUpload = "N";
    		param.method = "g5BackhaulTrafficSimulation";	// 필수. TrafficExcelBatchDAO 메소드명과 일치시키기
	        ...
	        param.fileName = "G5BackhaulTrafficSimulation" + "_" + dayTime + "." + param.fileExtension;
    		param.excelFlag = "G5BackhaulTrafficSimulation";

    		fileOnDemandName = param.fileName;
    		fileOnDemandExtension = param.fileExtension;

    		$('#'+gridId).alopexGrid('showProgress');
    		//param.fileName = "5G백홀트래픽시뮬레이션";
 	    	//httpRequest('tango-transmission-biz/trafficintg/trafficeng/excelcreateG5BackhaulTrafficSimulation', param, successCallbackExcel, failCallback, 'GET');
	...
	var successCallbackSearch = function(response){
		$('#'+gridId).alopexGrid('hideProgress');
		setSPGrid(gridId,response, response.g5BackhaulTrafficSimulation);
	}
