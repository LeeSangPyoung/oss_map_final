...
$a.page(function() {
    ...
    function setRegDataSet(data) {
    	...
    	$('#contentAreaPortLkup').setData(data);
    }
  ...
  //Grid 초기화
    function initGrid() {
        ...
        $('#'+gridId).alopexGrid({
    		...
    		rowOption:{inlineStyle: function(data,rowOption){
	    			if(data['portNm'] == $('#aportIdChnlValPortLkup').val() || data['portNm'] == $('#bportIdChnlValPortLkup').val()) 
    		...
    		columnMapping: [{
    			...
    			key : 'portSrvcDivNm', align:'left',
				title : '서비스명',
				width: '150px'
    		}, {
    			key : 'portCapaNm', align:'right',
				title : '속도(Mb)',
				width: '100px'
			}, {
				key : 'clctHms', align:'center',
				title : '시',
				width: '50px'
			}, {
    ...
    function setGrid(page, rowPerPage) {
    	...
    	$('#pageNoPortLkup').val(page);
    	$('#rowPerPagePortLkup').val(rowPerPage);
    	
    	 var param =  $("#searchFormPortLkup").getData();
		 
		 $('#'+gridId).alopexGrid('showProgress');
		 httpRequest('tango-transmission-biz/trafficintg/trafficeng/ptsRingTrafficPortLkup', param, 'GET', 'search');
    }
