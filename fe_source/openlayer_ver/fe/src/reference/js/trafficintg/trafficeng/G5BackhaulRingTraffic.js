...
//    	httpRequest('tango-transmission-biz/transmisson/configmgmt/commoncode/cfgStd/G5TRFWO', null, 'GET', 'g5Trfwo');
    	httpRequest('tango-transmission-biz/transmisson/configmgmt/commoncode/cfgStd/G5TRFWO', null, successCallbackCdList, failCallback, 'GET');
    ...
    function setGrid(page, rowPerPage) {
    	...
    	httpRequest('tango-transmission-biz/trafficintg/trafficeng/g5BackhaulRingTraffic', param, successCallbackSearch, failCallback, 'GET');
    }
    ...
    function setEventListener() {
        ...
        $('#'+gridId).on('dblclick', '.bodycell', function(e){
      		 ...
      		 var dataObj = null;
       	 	...
       	 	if (dataObj.clctDt != undefined &&  dataObj.clctDt != "" && dataObj.clctDt != null) {
	       	 	...
	       	 	/* 5G백홀 링 대표트래픽 장비 정보    	 */
	       	 	popupList('G5BackhaulRingTrafficEqpLkup', $('#ctx').val()+'/trafficintg/trafficeng/G5BackhaulRingTrafficEqpLkup.do', '5G백홀 링 대표트래픽 장비 정보',dataObj);
       	 	}
        ...
        $('#btnExportExcel').on('click', function(e) {
    		...
    		param.excelUpload = "N";
    		param.method = "g5BackhaulRingTraffic";	// 필수. TrafficExcelBatchDAO 메소드명과 일치시키기
	        ...
	        param.fileName = "G5BackhaulRingTraffic" + "_" + dayTime + "." + param.fileExtension;
    		param.excelFlag = "G5BackhaulRingTraffic";
    		...
    		$('#'+gridId).alopexGrid('showProgress');
    		//param.fileName = "5G백홀링대표트래픽";
 	    	//httpRequest('tango-transmission-biz/trafficintg/trafficeng/excelcreateG5BackhaulRingTraffic', param, successCallbackExcel, failCallback, 'GET');
...
//      	});
	...
	var successCallbackSearch = function(response){
		$('#'+gridId).alopexGrid('hideProgress');
		setSPGrid(gridId,response, response.g5BackhaulRingTraffic);
	}
