...
$a.page(function() {
    ...
    function setGrid(page, rowPerPage) {
    	...
    	httpRequest('tango-transmission-biz/trafficintg/trafficeng/lTwoSWTrafficCurstLkup', param, successCallbackSearch, failCallback, 'GET');
    }
    ...
    function setEventListener() {
        ...
        $('#btnExportExcel').on('click', function(e) {
    		...
    		param.excelUpload = "N";
    		param.method = "lTwoSWTrafficCurstLkup";	// 필수. TrafficExcelBatchDAO 메소드명과 일치시키기
    		...
    		param.fileName = "LTwoSWTrafficCurstLkup" + "_" + dayTime + "." + param.fileExtension;
    		param.excelFlag = "LTwoSWTrafficCurstLkup";     // 필수 값
    		...
    		$('#'+gridId).alopexGrid('showProgress');
    		//param.fileName = "L2SW트래픽현황조회";
 	    	//httpRequest('tango-transmission-biz/trafficintg/trafficeng/excelcreateLTwoSWTrafficCurstLkup', param, successCallbackExcel, failCallback, 'GET');
...
//	}
	...
	var successCallbackSearch = function(response){
		$('#'+gridId).alopexGrid('hideProgress');
		setSPGrid(gridId,response, response.l2SWTrafficCurstLkup);
	}
