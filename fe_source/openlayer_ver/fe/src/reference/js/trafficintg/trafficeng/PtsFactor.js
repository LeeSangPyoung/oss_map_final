...
var main = $a.page(function() {
    ...
    function setEventListener() {
        ...
        $('#'+gridIdPreTraffic).on('perPageChange', function(e){
            var eObj = AlopexGrid.parseEvent(e);
            main.setGridPreTraffic(1, eObj.perPage);
        });
	};
    ...
    function setSPGridTraffic(GridID,Option,Data) {
		var serverPageinfo = {
	       	...
	       	$('#'+gridIdTraffic).alopexGrid('dataSet', Data, serverPageinfo);
    ...
    function setSPGridPreTraffic(GridID,Option,Data) {
		var serverPageinfo = {
	       	...
	       	$('#'+gridIdPreTraffic).alopexGrid('dataSet', Data, serverPageinfo);
