/**
 * L2TrafficTrendLkup.js
 *
 * @author 이현우
 * @date 2016. 7. 20. 오후 03:27:00
 * @version 1.0
 */
$a.page(function() {
    ...
    function initGrid() {
	    ...
	    $('#'+gridId).alopexGrid({
	    	...
	    	columnMapping: [{
				...
				key : 'pts10G', align:'left',
				title : '10G PTS',
				width: '120px'
			}, {
				key : 'pts1G', align:'left',
				title : '1G PTS',
				width: '120px'
			}, {
				...
				key : 'mgmt', align:'center',
				title : '관리',
				width: '60px'
			}, {
				key : 'oper', align:'center',
				title : '운영',
				width: '60px'
			}, {
				key : 'eqpIp', align:'center',
				title : '장비 IP',
				width: '110px'
			}, {
				key : 'm1', align:'right',
  ...
  //select에 Bind 할 Code 가져오기
    function setSelectCode() {
        ...
        if($('#trendMon').is(':checked')){
	        ...
	        $('#'+gridId).alopexGrid("showCol", ['m11',  'm12']);	// (2017-04-20 : HS Kim) 추가
	        ...
	        $('#'+gridId).alopexGrid("hideCol", [ 'm11','m12' ], 'conceal');	// (2017-04-20 : HS Kim) 추가
    ...
    function setGrid(page, rowPerPage) {
    	...
    	httpRequest('tango-transmission-biz/trafficintg/statistics/lTwoTrafficTrendLkup', param, successCallbackSearch, failCallback, 'GET');
    }
    ...
    function setEventListener() {
      ...
      //엑셀다운로드
        $('#btnExportExcel').on('click', function(e) {
    		...
    		param.excelUpload = "N";
    		param.method = "lTwoTrafficTrendLkup";	// 필수. TrafficExcelBatchDAO 메소드명(Sql select id)과 일치시키기
    		...
    		param.fileName = "L2TrafficTrendLkup" + "_" + dayTime + "." + param.fileExtension;
    		param.excelFlag = "L2TrafficTrendLkup";     // 필수 값
    		...
    		$('#'+gridId).alopexGrid('showProgress');
    		//param.fileName = "L2트래픽추이조회";
 	    	//httpRequest('tango-transmission-biz/trafficintg/statistics/excelcreateLTwoTrafficTrendLkup', param, successCallbackExcel, failCallback, 'GET');
	...
	var successCallbackSearch = function(response){
		$('#'+gridId).alopexGrid('hideProgress');
		setSPGrid(gridId,response, response.l2TrafficTrendLkup);
	}
