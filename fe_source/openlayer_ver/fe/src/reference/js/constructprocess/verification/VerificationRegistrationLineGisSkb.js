/**
 * VerificationRegistrationLineGisSkb.js
 *
...
//				console.log(m.photoImgData);
    ...
    function setCategory(){
    	...
    	var flag = 'category';
        Tango.ajax({ url : 'tango-transmission-biz/transmission/constructprocess/verification/verificationRegistrationLineGisSkb'
                   , data : params
                   , method : 'GET'
     	           , flag: flag
    	 })
    ...
    function setPhotoInfo(params){
    	var flag = 'photoInfo';
        Tango.ajax({ url : 'tango-transmission-biz/transmission/constructprocess/verification/getVerificationRegistrationLineGisPhotoInfoListSkb'
                   , data : params
                   , method : 'GET'
     	           , flag: flag
    	 })
    ...
    function searchOpinion(){
        ...
        Tango.ajax({ url : 'tango-transmission-biz/transmission/constructprocess/verification/getVerificationRegistrationLineGisOpinionSkb/'+params.cstrCd+'/'+params.lnVrfClCd
                   , data : params
                   , method : 'GET'
     	           , flag: flag
    	 })
    ...
    function messageCallback(id,result){
		...
		case "save":
			...
			if(result == "Y"){
				...
				// 검증등록-ETE 검증의견 저장,수정
	        	Tango.ajax({ url : 'tango-transmission-biz/transmission/constructprocess/verification/insertVerificationRegistrationLineGisOpinionSkb/'+params.cstrCd+'/'+params.lnVrfClCd+'?method=put'
	  	                   , data : params
	                       , method : 'POST'
	            	       , flag: flag
	  			 })
