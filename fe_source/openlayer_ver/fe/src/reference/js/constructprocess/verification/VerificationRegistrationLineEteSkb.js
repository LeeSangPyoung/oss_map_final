...
var m = {
			...
			ajaxProp  	: [
				             ...
				             {  // Search Opinion
				            	url:'tango-transmission-biz/transmission/constructprocess/verification/getVerificationRegistrationLineEteOpinionSkb',
				            	data:"",
				            	flag:'searchOpinion' // 2
				             },
				             {  // Search Exemption Yn
				             	url:'tango-transmission-biz/transmission/constructprocess/verification/getVerificationRegistrationLineEteExemptionStatusSkb',
				             	data:"",
				             	flag:'searchExemptionYn' // 3
				             },
				             {  // saveOpinion
				             	url:'tango-transmission-biz/transmission/constructprocess/verification/insertVerificationRegistrationLineEteOpinionSkb',
				              	data:"",
				              	flag:'saveOpinion' // 4
				             },
				             {  // BP사 의견 및 검증제외 조회 
				             ...
				             {  // 배치 셋팅
				            	url:'tango-transmission-biz/transmission/constructprocess/verification/setOndemandedExcelDownloadBatchSkb/',
				            	data:"",
				            	flag:'setBatch' // 6 : 
				             },
				             {  // 배치 상태 조회
				            	url:'tango-transmission-biz/transmisson/constructprocess/common/excelBatchExecuteStatusSkb/', // jobInstanceId
				            	data:"",
...
var localPage = $a.page(function() {
    ...
    this.init = function(id, param) {   	
    	...
    	m.params.skGroup = 'SKB'; // GIS API 파라미터
