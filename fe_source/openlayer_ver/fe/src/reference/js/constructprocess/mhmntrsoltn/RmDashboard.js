...
function linkManhole(data) {
	...
	$a.navigate('/tango-transmission-web/constructprocess/mhmntrsoltn/MhStatCurstLst.do', data);
}

function linkManholeSnsr(data) {
	
	$a.navigate('/tango-transmission-web/constructprocess/mhmntrsoltn/MhSnsrStatCurstLst.do', data);
}
