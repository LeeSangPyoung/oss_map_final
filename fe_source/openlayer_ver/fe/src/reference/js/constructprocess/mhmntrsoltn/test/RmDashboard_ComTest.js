...
function linkManhole(data) {
	...
	parent.$a.navigate('/tango-transmission-web/constructprocess/mhmntrsoltnTest/MhStatCurstLstTest.do', data);
}

function linkManholeSnsr(data) {
	
	parent.$a.navigate('/tango-transmission-web/constructprocess/mhmntrsoltnTest/MhSnsrStatCurstLstTest.do', data);
}
