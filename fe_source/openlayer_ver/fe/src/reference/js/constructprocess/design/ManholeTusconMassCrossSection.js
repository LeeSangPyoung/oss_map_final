/**
 * ManholeTusconMassCrossSection.js
 *
 * @author P096293
...
$a.page(function() {
    ...
    var setHeight = function (){
    	...
    	spanObj.t1 = 'T='+((parseFloat(spanObj.h1)+parseFloat(spanObj.h2))*100)+'cm';
    	spanObj.h2 = truncate(parseFloat($('select[name=assiBaseHght]').val()),3);
    ...
    var setWidth = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			...
    			spanObj.w2 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),3);
    ...
    var massCalc = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			...
    			spanObj.d2 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),3);
    ...
    var setParam = function (){
    	...
    	$('#conCutLenm').text(0);
    	//03.포장깨기 AS
    	$('#asptPavmtStBrkgVlme').text(truncate((parseFloat(obj('w1')) * parseFloat(obj('d1')) * parseFloat(obj('h1'))),2));
    	//04.포장깨기 COM
    	...
    	if ('2' == rockAplyDivCd) { //연암
    		...
    		$('#hveqEcvtVlme').text(truncate(parseFloat($('#asptPavmtStBrkgVlme').text()) + parseFloat($('#sfrokPavmtBrkgVlme').text()),3));
    		...
    		$('#gnrlRckPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')) + parseFloat(obj('h8')))),3));
    		$('#hdrokPavmtBrkgVlme').text(0);
    		$('#hveqEcvtVlme').text(truncate(parseFloat($('#asptPavmtStBrkgVlme').text()) + parseFloat($('#gnrlRckPavmtBrkgVlme').text()),3));
    		$('#soilHveqEcvtVlme').text(0);
    		$('#hrscEcvtDistm1').text(0);
    		$('#hrscEcvtDistm2').text(0);
    		$('#hrscEcvtDistm3').text(0);
    		...
    		$('#sfrokPavmtBrkgVlme').text(0);
    		$('#gnrlRckPavmtBrkgVlme').text(0);
    		$('#hdrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7'))  + parseFloat(obj('h8')))),3));
    		$('#hveqEcvtVlme').text(truncate(parseFloat($('#asptPavmtStBrkgVlme').text()) + parseFloat($('#hdrokPavmtBrkgVlme').text()),3));
    		$('#soilHveqEcvtVlme').text(0);
    		$('#hrscEcvtDistm1').text(0);
    		$('#hrscEcvtDistm2').text(0);
    		$('#hrscEcvtDistm3').text(0);
    		...
    		$('#soilHveqEcvtVlme').text(truncate(((parseFloat(obj('w1')) + parseFloat(obj('w4'))) / 2) * ((parseFloat(obj('d1')) + parseFloat(obj('d4'))) / 2) * (parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4'))),3));
    	...
    	$('#soilCpctRate').text(0);
    	//15.환토다짐
    	$('#resoilCpctVlme').text(truncate((parseFloat(obj('w3')) + parseFloat(obj('w8'))) / 2 * (parseFloat(obj('d3')) + parseFloat(obj('d8'))) / 2 * parseFloat(obj('h10')) - parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h10')), 2));
    	//16.환토비다짐(인력)
    	$('#rsnpRate').text(truncate(parseFloat(obj('w8')) * parseFloat(obj('d8')) * parseFloat(obj('h11')),2));
    	//13.환토
    	...
    	//22.복구정보 표층
    	$('#rcovSufcHght1').text(truncate($('select[name=sufcHght]').val(),2));
    	//23.복구정보 기층
    	$('#rcovBaseHght').text(0);
    	//24.복구정보 보조기층1
    	if (1 == assiBaseGadtTypeCd && '65' == fcltKndCd) {
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('w3'))) / 2 * (parseFloat(obj('d1')) + parseFloat(obj('d3'))) / 2 * parseFloat(obj('h9')) - 0.96 * 0.46 * 0.02 ,2));
    	} else if (1 == assiBaseGadtTypeCd && '65' != fcltKndCd) {
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('w3'))) / 2 * (parseFloat(obj('d1')) + parseFloat(obj('d3'))) / 2 * parseFloat(obj('h9')),2));
    	} else if (1 != assiBaseGadtTypeCd && '65' == fcltKndCd) { 
    		$('#rcovAssiBaseHght1').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')) * parseFloat(obj('h9')) - 0.96 * 0.46 * 0.02, 2));
    	} else {
    		$('#rcovAssiBaseHght1').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')) * parseFloat(obj('h9')), 2));
    	}
    	//25.복구정보 보조기층2
