/**
 * ManholePavementMassCrossSection.js
 *
 * @author P096293
 * @date 2016. 8. 31. 오전 17:30:03
 * @version 1.0
 */
$a.page(function() {
    ...
    var setHeight = function (){
    	...
    	spanObj.h2 = truncate((0.1 - parseFloat(spanObj.h1)),2);
    	spanObj.h3 = truncate((0.3 -  parseFloat(spanObj.h1) -  parseFloat(spanObj.h2)),2);
    	spanObj.h4 = truncate((0.8 - (parseFloat(spanObj.h1) + parseFloat(spanObj.h2) + parseFloat(spanObj.h3))),2);
    	spanObj.h5 = '0.2';
    	...
    	spanObj.h9 = truncate(parseFloat(spanObj.h2),3);
    	...
    	spanObj.h11 = truncate(parseFloat($('select[name=assiBaseHght]').val()) - parseFloat(spanObj.h10),3);
    	spanObj.h13 = '0.1';
    ...
    var setWidth = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			//w1 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h3+h4+h5+h6+h7)*0.6+w8)
    			spanObj.w1 = truncate(((parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    			//w2 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h4+h5+h6+h7)*0.6+w8)
    			spanObj.w2 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    			...
    			//w6 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h7)*0.6+w8
    			spanObj.w6 = truncate(((parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    ...
    var massCalc = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			//d1 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h3+h4+h5+h6+h7)*0.6+d8)
    			spanObj.d1 = truncate(((parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6) + parseFloat(spanObj.d8),2);
    			//d2 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h4+h5+h6+h7)*0.6+d8)
    			spanObj.d2 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),2);
    			//d3 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h4+h5+h6+h7)*0.6+d8)
    			spanObj.d3 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),2);
    			//d4 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h5+h6+h7)*0.6+d8)
    			spanObj.d4 = truncate((((parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6) + parseFloat(spanObj.d8)),2);
    			//d5 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h6+h7)*0.6+d8)
    			spanObj.d5 = truncate(((parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),2);
    			//d6 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h7)*0.6+d8)
    			spanObj.d6 = truncate(((parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),2);
    			//d7 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h7)*0.6+d8)
    			spanObj.d7 = truncate(((parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),2);
    		} else {
    ...
    var setParam = function (){
    	...
    	if ('2' == rockAplyDivCd) { //연암
    		...
    		$('#gnrlRckPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))),2));
    		$('#hdrokPavmtBrkgVlme').text(0);
    		...
    		$('#sfrokPavmtBrkgVlme').text(0);
    		$('#gnrlRckPavmtBrkgVlme').text(0);
    		$('#hdrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))),2));
    		...
    		//alert(parseFloat(obj('w1')));
    		//alert(parseFloat(obj('w4')));
    		//alert(parseFloat(obj('d1')));
    		//alert(parseFloat(obj('d4')));
    		//alert(parseFloat(obj('h2')));
    		//alert(parseFloat(obj('h3')));
    		//alert(parseFloat(obj('h4')));
    	...
    	$('#soilCpctRate').text(0);
    	//15.환토다짐
    	$('#resoilCpctVlme').text(truncate((parseFloat(obj('w3')) + parseFloat(obj('w8'))) / 2 * (parseFloat(obj('d3')) + parseFloat(obj('d8'))) / 2 * parseFloat(obj('h12')) - parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h12')), 2));
    	//16.환토비다짐(인력)
    	$('#rsnpRate').text(truncate(parseFloat(obj('w8')) * parseFloat(obj('d8')) * parseFloat(obj('h13')),2));
    	//13.환토
    	...
    	//19.보도걷기
    	$('#pvmtSkimAr').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')),2));
    	//20.노면청소
    	$('#stSufcClenAr').text(0);
    	//21.복구정보 복구폭
    	...
    	if (1 == assiBaseGadtTypeCd && '65' == fcltKndCd) {
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('w3'))) / 2 * (parseFloat(obj('d1')) + parseFloat(obj('d3'))) / 2 * (parseFloat(obj('h10')) + parseFloat(obj('h11'))) - (parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h11'))) - (0.96 * 0.46 * parseFloat(obj('h10'))) ,2));
    	} else if (1 == assiBaseGadtTypeCd && '65' != fcltKndCd) {
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('w3'))) / 2 * (parseFloat(obj('d1')) + parseFloat(obj('d3'))) / 2 * (parseFloat(obj('h10')) + parseFloat(obj('h11'))) - (parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h11'))) - (((1.37/2) * (1.37/2)) * 3.14 * parseFloat(obj('h11'))) ,2));
    	} else if (1 != assiBaseGadtTypeCd && '65' == fcltKndCd) { 
    		$('#rcovAssiBaseHght1').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')) * (parseFloat(obj('h10')) + parseFloat(obj('h11'))) - (parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h11'))) - (0.96 * 0.46 * parseFloat(obj('h10'))) ,2));
    	} else {
    		$('#rcovAssiBaseHght1').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')) * (parseFloat(obj('h10')) + parseFloat(obj('h11'))) - (parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h11'))) - (((1.37/2) * (1.37/2)) * 3.14 * parseFloat(obj('h11'))) ,2));
    	}
    	//25.복구정보 보조기층2
    ...
    var successCallback = function (response,state,xhr,flag){
    	...
    	if ('search' == flag) {
    		...
    		$.each($('select[name=sufcHght]').children() , function () {
    			if (this.value == parseFloat(returnData.sufcHght).toFixed(2)) {
    				$(this).attr('selected','selected');
