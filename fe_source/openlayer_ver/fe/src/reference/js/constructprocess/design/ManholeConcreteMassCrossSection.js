/**
 * ManholeConcreteMassCrossSection.js
 *
 * @author P096293
...
$a.page(function() {
    ...
    var setHeight = function (){
    	...
    	spanObj.h9 = truncate(parseFloat($('select[name=assiBaseHght]').val()),3);
    	spanObj.h11 = '0.1';
    ...
    var setWidth = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			//w1 : if(암반적용유무 == 미적용)  then trunc((h2+h3+h4+h5+h6+h7)*0.6+w8)
    			spanObj.w1 = truncate(((parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),3);
    			//w2 : if(암반적용유무 == 미적용)  then trunc((h3+h4+h5+h6+h7)*0.6+w8)
    			spanObj.w2 = truncate(((parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),3);
    			//w3 : if(암반적용유무 == 미적용)  then trunc((h4+h5+h6+h7)*0.6+w8)
    			spanObj.w3 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),3);
    			//w4 : if(암반적용유무 == 미적용)  then trunc((h5+h6+h7)*0.6+w8)
    			spanObj.w4 = truncate(((parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),3);
    			//w5 : if(암반적용유무 == 미적용)  then trunc((h6+h7)*0.6+w8)
    			spanObj.w5 = truncate(((parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),3);
    			//w6 : if(암반적용유무 == 미적용)  then trunc((h6+h7)*0.6+w8)
    			spanObj.w6 = truncate(((parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),3);
    			//w7 : if(암반적용유무 == 미적용)  then trunc((h7)*0.6+w8)
    ...
    var massCalc = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			//d1 : if(암반적용유무 == 미적용)  then trunc((h2+h3+h4+h5+h6+h7)*0.6+d8)
    			...
    			//d2 : if(암반적용유무 == 미적용)  then trunc((h3+h4+h5+h6+h7)*0.6+d8)
    ...
    var setParam = function (){
    	...
    	//04.포장깨기 COM
    	$('#conPavmtBrkgVlme').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')) * parseFloat(obj('h1')),2));
    	...
    	$('#soilCpctRate').text(0);
    	//15.환토다짐
    	$('#resoilCpctVlme').text(truncate((parseFloat(obj('w4')) + parseFloat(obj('w8'))) / 2 * (parseFloat(obj('d4')) + parseFloat(obj('d8'))) / 2 * parseFloat(obj('h10')) - parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h10')), 2));
    	//16.환토비다짐(인력)
