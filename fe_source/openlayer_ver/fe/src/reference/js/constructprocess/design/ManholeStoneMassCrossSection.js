/**
 * ManholeStoneMassCrossSection.js
 *
 * @author P096293
...
$a.page(function() {
    ...
    var setHeight = function (){
    	...
    	spanObj.h2 = '0.04';
    	spanObj.h3 = '0.1';
    	spanObj.h4 = truncate((0.3 - parseFloat(spanObj.h1) - parseFloat(spanObj.h2) - parseFloat(spanObj.h3)),3);
    	spanObj.h5 = truncate((0.8 - parseFloat(spanObj.h1) - parseFloat(spanObj.h2) - parseFloat(spanObj.h3) - parseFloat(spanObj.h4)),3);
    	spanObj.h6 = '0.2';
    	...
    	spanObj.h8 = truncate((parseFloat(m.setting(v1RowIndex)['H3']) - parseFloat(spanObj.h1) - parseFloat(spanObj.h2) - parseFloat(spanObj.h3) - parseFloat(spanObj.h4) - parseFloat(spanObj.h5) - parseFloat(spanObj.h6) - parseFloat(spanObj.h7)),3);
    	spanObj.h9 = truncate(parseFloat($('select[name=sufcHght]').val()),3);
    	spanObj.h9 = truncate(parseFloat(spanObj.h2),3);
    	spanObj.h10 = '0.04';
    	spanObj.h11 = '0.1';
    	spanObj.h12 = '0.1';
    	spanObj.h14 = '0.1';
    	spanObj.h13 = truncate((parseFloat(m.setting(v1RowIndex)['H3']) - parseFloat(spanObj.h9) - parseFloat(spanObj.h10) - parseFloat(spanObj.h11) - parseFloat(spanObj.h12) - parseFloat(spanObj.h14)),3);
    ...
    var setWidth = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			spanObj.w1 = truncate(((parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')) + parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w2 = truncate(spanObj.w1,3);
    			spanObj.w3 = truncate(((parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')) + parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w4 = truncate(((parseFloat(obj('h6')) + parseFloat(obj('h7')) + parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w5 = truncate(((parseFloat(obj('h7')) + parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w6 = truncate(((parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w7 = truncate(((parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.w8)),3);
    		} else {
    ...
    var massCalc = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			spanObj.d1 = truncate(((parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')) + parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d2 = truncate(spanObj.d1,3);
    			spanObj.d3 = truncate(((parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')) + parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d4 = truncate(((parseFloat(obj('h6')) + parseFloat(obj('h7')) + parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d5 = truncate(((parseFloat(obj('h7')) + parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d6 = truncate(((parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d7 = truncate(((parseFloat(obj('h8')))*0.6 + parseFloat(spanObj.d8)),3);
    		} else {
    ...
    var setParam = function (){
    	...
    	//02.포장절단 CON
    	$('#conCutLenm').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('d1'))) * 2, 2));
    	//03.포장깨기 AS
    	$('#asptPavmtStBrkgVlme').text(0);
    	//04.포장깨기 COM
    	$('#conPavmtBrkgVlme').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')) * (parseFloat(obj('h1')) + parseFloat(obj('h2')) + parseFloat(obj('h3'))), 2));
    	
    	//05.포장깨기 연암, 06.포장깨기 보통암, 07.포장깨기 경암, 08.중기터파기(사석), 09.중기터파기(토사), 10.인력터파기 0-1M, 11.인력터파기 1-2M, 12.인력터파기 2-3M
    	if ('2' == rockAplyDivCd) { //연암
    		$('#sfrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')) + parseFloat(obj('h8')))),2));
    		$('#gnrlRckPavmtBrkgVlme').text(0);
    		$('#hdrokPavmtBrkgVlme').text(0);
    		$('#hveqEcvtVlme').text(truncate(parseFloat($('#conPavmtBrkgVlme').text()) + parseFloat($('#sfrokPavmtBrkgVlme').text()),2));
    		...
    		$('#gnrlRckPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7'))  + parseFloat(obj('h8')))),2));
    		$('#hdrokPavmtBrkgVlme').text(0);
    		$('#hveqEcvtVlme').text(truncate(parseFloat($('#conPavmtBrkgVlme').text()) + parseFloat($('#gnrlRckPavmtBrkgVlme').text()),2));
    		$('#soilHveqEcvtVlme').text(0);
    		$('#hrscEcvtDistm1').text(0);
    		$('#hrscEcvtDistm2').text(0);
    		$('#hrscEcvtDistm3').text(0);
    		...
    		$('#sfrokPavmtBrkgVlme').text(0);
    		$('#gnrlRckPavmtBrkgVlme').text(0);
    		$('#hdrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7'))  + parseFloat(obj('h7')))),2));
    		$('#hveqEcvtVlme').text(truncate(parseFloat($('#conPavmtBrkgVlme').text()) + parseFloat($('#hdrokPavmtBrkgVlme').text()),2));
    		$('#soilHveqEcvtVlme').text(0);
    		$('#hrscEcvtDistm1').text(0);
    		$('#hrscEcvtDistm2').text(0);
    		$('#hrscEcvtDistm3').text(0);
    		...
    		$('#soilHveqEcvtVlme').text(truncate(((parseFloat(obj('w2')) + parseFloat(obj('w4'))) / 2) * ((parseFloat(obj('d2')) + parseFloat(obj('d4'))) / 2) * (parseFloat(obj('h4')) + parseFloat(obj('h5'))),2));
    		$('#hrscEcvtDistm1').text(truncate(((parseFloat(obj('w4')) + parseFloat(obj('w5'))) / 2) * ((parseFloat(obj('d4')) + parseFloat(obj('d5'))) / 2) * parseFloat(obj('h6')),2));
    		$('#hrscEcvtDistm2').text(truncate(((parseFloat(obj('w5')) + parseFloat(obj('w7'))) / 2) * ((parseFloat(obj('d5')) + parseFloat(obj('d7'))) / 2) * parseFloat(obj('h7')),2));
    		$('#hrscEcvtDistm3').text(truncate(((parseFloat(obj('w7')) + parseFloat(obj('w8'))) / 2) * ((parseFloat(obj('d7')) + parseFloat(obj('d8'))) / 2) * parseFloat(obj('h8')),2));
    	}
    	...
    	//15.환토다짐
    	if ('65' == fcltKndCd) {
    		$('#resoilCpctVlme').text(truncate((parseFloat(obj('w3')) + parseFloat(obj('w8'))) / 2 * (parseFloat(obj('d3')) + parseFloat(obj('d8'))) / 2 * parseFloat(obj('h13')) - (parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h13')) - 0.96 * 0.46 * 0), 2));
    	} else {
    		$('#resoilCpctVlme').text(truncate((parseFloat(obj('w3')) + parseFloat(obj('w8'))) / 2 * (parseFloat(obj('d3')) + parseFloat(obj('d8'))) / 2 * parseFloat(obj('h13')) - (parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(m.setting(v1RowIndex)['H2'])) - (((1.37/2) * (1.37/2)) * 3.14 * (parseFloat(obj('h13')) - parseFloat(m.setting(v1RowIndex)['H2']))), 2));
    	}
    	//16.환토비다짐(인력)
    	$('#rsnpRate').text(truncate(parseFloat(obj('w8')) * parseFloat(obj('d8')) * parseFloat(obj('h14')),2));
    	//13.환토
    	...
    	if (1 == assiBaseGadtTypeCd && '65' == fcltKndCd) {
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w2')) + parseFloat(obj('w3'))) / 2 * (parseFloat(obj('d2')) + parseFloat(obj('d3'))) / 2 * parseFloat(obj('h12')) - parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * 0.1 ,2));
    	} else if (1 == assiBaseGadtTypeCd && '65' != fcltKndCd) {
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w2')) + parseFloat(obj('w3'))) / 2 * (parseFloat(obj('d2')) + parseFloat(obj('d3'))) / 2 * parseFloat(obj('h12')) - ((1.37/2) *(1.37/2) * 3.14 * parseFloat(obj('h11'))),2));
    	} else if (1 != assiBaseGadtTypeCd && '65' == fcltKndCd) { 
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('w2'))) / 2 * (parseFloat(obj('d1')) + parseFloat(obj('d2'))) / 2 * parseFloat(obj('h12')) - parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * 0.1 ,2));
    	} else {
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('w2'))) / 2 * (parseFloat(obj('d1')) + parseFloat(obj('d2'))) / 2 * parseFloat(obj('h12')) - ((1.37/2) *(1.37/2) * 3.14 * parseFloat(obj('h11'))),2));
    	}
    	//25.복구정보 보조기층2
