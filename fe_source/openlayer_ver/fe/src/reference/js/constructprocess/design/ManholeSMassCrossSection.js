...
$a.page(function() {
    	...
    	m.button(0).on('click', function (){
    		var param = {
				...
				'dsnSetlDiv':dsnSetlDiv,
			   	...
			   	'sufcHght':$('input[name=sufcHght]').val(),
			   	...
			   	'assiBaseHght':$('input[name=assiBaseHght]').val(),
			   	'assiBaseGadtTypCd':$('input[name=assiBaseGadtTypeCd]').val(),
    ...
    var setHeight = function (){
    	...
    	spanObj.h1 = '0.3';
    	spanObj.t1 = 'T=0cm';
    	spanObj.h2 = truncate((0.8 - parseFloat(spanObj.h1)),3);
    	spanObj.h3 = '0.2';
    	...
    	spanObj.h5 = truncate((parseFloat(m.setting(v1RowIndex)['H3']) - parseFloat(spanObj.h1) - parseFloat(spanObj.h2) - parseFloat(spanObj.h3) - parseFloat(spanObj.h4)),3);
    	spanObj.h7 = '0.1';
    	spanObj.h6 = truncate(parseFloat(m.setting(v1RowIndex)['H3']) - parseFloat(spanObj.h7),3);
    ...
    var setWidth = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			spanObj.w1 = truncate(((parseFloat(obj('h1')) + parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w2 = truncate(((parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w3 = truncate(((parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w4 = truncate(((parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w5 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w6 = truncate(((parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.w8)),3);
    			spanObj.w7 = truncate(((parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.w8)),3);
    		} else {
    ...
    var massCalc = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			spanObj.d1 = truncate(((parseFloat(obj('h1')) + parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d2 = truncate(((parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d3 = truncate(((parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d4 = truncate(((parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d5 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d6 = truncate(((parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.d8)),3);
    			spanObj.d7 = truncate(((parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.d8)),3);
    		} else {
    ...
    var setParam = function (){
    	...
    	if ('2' == rockAplyDivCd) { //연암
    		$('#sfrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h1')) + parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))),2));
    		...
    		$('#gnrlRckPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h1')) + parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))),2));
    		$('#hdrokPavmtBrkgVlme').text(0);
    		...
    		$('#sfrokPavmtBrkgVlme').text(0);
    		$('#gnrlRckPavmtBrkgVlme').text(0);
    		$('#hdrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h1')) + parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))),2));
    		...
    		//9
    		$('#soilHveqEcvtVlme').text(truncate(((parseFloat(obj('w1')) + parseFloat(obj('w4'))) / 2) * ((parseFloat(obj('d1')) + parseFloat(obj('d4'))) / 2) * (parseFloat(obj('h1')) + parseFloat(obj('h2'))),2));
    		//10
    		$('#hrscEcvtDistm1').text(truncate(((parseFloat(obj('w4')) + parseFloat(obj('w5'))) / 2) * ((parseFloat(obj('d4')) + parseFloat(obj('d5'))) / 2) * parseFloat(obj('h3')),2));
    		//11
    		$('#hrscEcvtDistm2').text(truncate(((parseFloat(obj('w5')) + parseFloat(obj('w7'))) / 2) * ((parseFloat(obj('d5')) + parseFloat(obj('d7'))) / 2) * parseFloat(obj('h4')),2));
    		//12
    		$('#hrscEcvtDistm3').text(truncate(((parseFloat(obj('w7')) + parseFloat(obj('w8'))) / 2) * ((parseFloat(obj('d7')) + parseFloat(obj('d8'))) / 2) * parseFloat(obj('h5')),2));
    	}
    	
    	//14.토사다짐
    	if ('65' == fcltKndCd) { //수공1호
    		$('#soilCpctRate').text(truncate(((parseFloat(obj('w1')) + parseFloat(obj('w8'))) /2) * ((parseFloat(obj('d1')) + parseFloat(obj('d8'))) / 2) * (parseFloat(obj('h6'))) - ((parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(m.setting(v1RowIndex)['H2'])) + (0.960 * 0.460 * 0.25)),2));
    	} else {
    		$('#soilCpctRate').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('w8'))) /2 * (parseFloat(obj('d1')) + parseFloat(obj('d8'))) / 2 * (parseFloat(obj('h6'))) - ((parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(m.setting(v1RowIndex)['H2'])) + (((1.37/2) * (1.37/2)) * 3.14 * 0.3)),2));
    	}
    	
    	//15.환토다짐
    	$('#resoilCpctVlme').text(0);
    	//16.환토비다짐(인력)
    	$('#rsnpRate').text(truncate(parseFloat(obj('w8')) * parseFloat(obj('d8')) * parseFloat(obj('h7')),2));
    	//13.환토
    	...
    	//18.중기잔토처리(토사)
    	var hveqSsopTemp = truncate(parseFloat($('#soilHveqEcvtVlme').text()) + parseFloat($('#hrscEcvtDistm1').text()) + parseFloat($('#hrscEcvtDistm2').text()) + parseFloat($('#hrscEcvtDistm3').text()) - parseFloat($('#soilCpctRate').text()),2);
    	if (0 > parseFloat(hveqSsopTemp)) {
    		hveqSsopTemp = 0;
    	}
    	$('#hveqSsopVlme').text(truncate(hveqSsopTemp,2));
    	//19.보도걷기
    	$('#pvmtSkimAr').text(0);
    	//20.노면청소
    	$('#stSufcClenAr').text(0);
    	...
    	$('#rcovBaseWdth').text(0);
    	//22.복구정보 표층
    	$('#rcovSufcHght1').text(0);
    	//23.복구정보 기층
    	$('#rcovBaseHght').text(0);
    	//24.복구정보 보조기층1
    	$('#rcovAssiBaseHght1').text(0);
    	//25.복구정보 보조기층2
