/**
 * ManholeHomeSiteMassCrossSection.js
 *
 * @author P096293
...
$a.page(function() {
    ...
    var setHeight = function (){
    	...
    	spanObj.h7 = '0.1';
    	spanObj.h6 = truncate(parseFloat(m.setting(v1RowIndex)['H3']) - parseFloat(spanObj.h7) - parseFloat(spanObj.h1),3);
    ...
    var setWidth = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			spanObj.w1 = truncate(((parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.w8)),3);
    ...
    var massCalc = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			spanObj.d1 = truncate(((parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))*0.6 + parseFloat(spanObj.d8)),3);
    ...
    var setParam = function (){
    	...
    	if ('2' == rockAplyDivCd) { //연암
    		$('#sfrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))),2));
    		...
    		$('#gnrlRckPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))),2));
    		$('#hdrokPavmtBrkgVlme').text(0);
    		...
    		$('#sfrokPavmtBrkgVlme').text(0);
    		$('#gnrlRckPavmtBrkgVlme').text(0);
    		$('#hdrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')))),2));
    		...
    		$('#soilHveqEcvtVlme').text(truncate(((parseFloat(obj('w1')) + parseFloat(obj('w8'))) / 2) * ((parseFloat(obj('d1')) + parseFloat(obj('d8'))) / 2) * (parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5'))),2));
    		$('#hrscEcvtDistm1').text(0);
    		$('#hrscEcvtDistm2').text(0);
    		$('#hrscEcvtDistm3').text(0);
    	}
    	...
    	//14.토사다짐
    	$('#soilCpctRate').text(truncate((parseFloat(obj('w3')) + parseFloat(obj('w8'))) / 2 * (parseFloat(obj('d3')) + parseFloat(obj('d8'))) / 2 * (parseFloat(obj('h6'))) - parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h6')),2));
    	//15.환토다짐
    	...
    	//18.중기잔토처리(토사)
    	var hveqSsopTemp = truncate(parseFloat($('#soilHveqEcvtVlme').text()) - parseFloat($('#soilCpctRate').text()),2);
