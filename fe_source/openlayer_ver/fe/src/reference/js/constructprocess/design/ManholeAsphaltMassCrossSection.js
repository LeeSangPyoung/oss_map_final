/**
 * ManholeAsphaltMassCrossSection.js
 *
 * @author P096293
 * @date 2016. 8. 29. 오전 17:30:03
 * @version 1.0
 */
$a.page(function() {
    	...
    	m.button(0).on('click', function (){
    		...
    		var param = {
				...
				'dsnSetlDiv':dsnSetlDiv,
			   	...
			   	'fsbtPrvntAssiBaseHght':$('select[name=fsbtPrvntAssiBaseHght]').val(),
			   	'assiBaseGadtAplyEyn':$('select[name=assiBaseGadtAplyEyn]').val(),
    ...
    var setHeight = function (){
    	...
    	spanObj.h1 = parseFloat($('select[name=sufcHght]').val());
    	spanObj.t1 = 'T='+(parseFloat(spanObj.h1)*100)+'cm';
    	spanObj.h2 = truncate((0.3 - parseFloat(spanObj.h1)),3);
    	spanObj.h3 = truncate((parseFloat($('select[name=assiBaseHght]').val()) - parseFloat(spanObj.h2)),3);
    	spanObj.h4 = 0.8 -(parseFloat(spanObj.h1) + parseFloat(spanObj.h2) + parseFloat(spanObj.h3));
    	spanObj.h5 = '0.2';
    	...
    	spanObj.h8 = '0.05';
    	spanObj.h9 = truncate((parseFloat(spanObj.h1) - parseFloat(spanObj.h8)),3);
    	spanObj.h10 = parseFloat($('select[name=assiBaseHght]').val());
    	spanObj.h11 = parseFloat($('select[name=fsbtPrvntAssiBaseHght]').val());
    	spanObj.h13 = '0.1';
    	spanObj.h12 = truncate((parseFloat(m.setting(v1RowIndex)['H3']) - parseFloat(spanObj.h8) - parseFloat(spanObj.h9) - parseFloat(spanObj.h10) - parseFloat(spanObj.h11) - parseFloat(spanObj.h13)),3);
    ...
    var setWidth = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			//w1 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h2+h3+h4+h5+h6+h7)*0.6+w8)
    			spanObj.w1 = truncate(((parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    			//w2 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h3+h4+h5+h6+h7)*0.6+w8)
    			spanObj.w2 = truncate(((parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    			//w3 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h4+h5+h6+h7)*0.6+w8)
    			spanObj.w3 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    			//w4 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h5+h6+h7)*0.6+w8)
    			spanObj.w4 = truncate(((parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    			
    			//w5 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h6+h7)*0.6+w8)
    			spanObj.w5 = truncate(((parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    			//w6 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h6+h7)*0.6+w8)
    			spanObj.w6 = truncate(((parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    			//w7 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h7)*0.6+w8)
    			spanObj.w7 = truncate(((parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.w8)),2);
    		} else {
    ...
    var massCalc = function (){
    	...
    	if ('1' == param.rockAplyDivCd) { //미적용
    		if ('0.3' == $('select[name=gadtRate]').val()) { //구배율
    			//d1 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h2+h3+h4+h5+h6+h7)*0.6+d8)
    			spanObj.d1 = truncate(((parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),3);
    			//d2 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h3+h4+h5+h6+h7)*0.6+d8)
    			spanObj.d2 = truncate(((parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),3);
    			//d3 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h4+h5+h6+h7)*0.6+d8)
    			spanObj.d3 = truncate(((parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),3);
    			//d4 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h5+h6+h7)*0.6+d8)
    			spanObj.d4 = truncate(((parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),3);
    			//d5 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h6+h7)*0.6+d8)
    			spanObj.d5 = truncate(((parseFloat(obj('h6')) + parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),3);
    			//d6 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h6+h7)*0.6+d8)
    			spanObj.d6 = truncate(((parseFloat(obj('h7')))*0.6 + parseFloat(spanObj.d8)),3);
    			//d7 : if(암반적용유무 == 미적용) then if(구배율 = 0.3) then trunc((h7)*0.6+d8)
    ...
    var setParam = function (){
    	...
    	//01.포장절단 AS
    	$('#asptPavmtCutLenm').text(truncate(((parseFloat(obj('w1')) + parseFloat(obj('d1'))) * 2),2));
    	//02.포장절단 CON
    	$('#conCutLenm').text(0);
    	//03.포장깨기 AS
    	$('#asptPavmtStBrkgVlme').text(truncate((parseFloat(obj('w1')) * parseFloat(obj('d1')) * parseFloat(obj('h1'))),1));
    	
    	//04.포장깨기 COM
    	$('#conPavmtBrkgVlme').text(0);
    	
    	//05.포장깨기 연암, 06.포장깨기 보통암, 07.포장깨기 경암, 08.중기터파기(사석), 09.중기터파기(토사), 10.인력터파기 0-1M, 11.인력터파기 1-2M, 12.인력터파기 2-3M
    	if ('2' == rockAplyDivCd) { //연암
    		$('#sfrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))),2));
    		$('#gnrlRckPavmtBrkgVlme').text(0);
    		$('#hdrokPavmtBrkgVlme').text(0);
    		$('#hveqEcvtVlme').text(truncate(parseFloat($('#asptPavmtStBrkgVlme').text()) + parseFloat($('#sfrokPavmtBrkgVlme').text()),2));
    		...
    		$('#gnrlRckPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))),2));
    		$('#hdrokPavmtBrkgVlme').text(0);
    		$('#hveqEcvtVlme').text(truncate(parseFloat($('#asptPavmtStBrkgVlme').text()) + parseFloat($('#gnrlRckPavmtBrkgVlme').text()),2));
    		$('#soilHveqEcvtVlme').text(0);
    		$('#hrscEcvtDistm1').text(0);
    		$('#hrscEcvtDistm2').text(0);
    		$('#hrscEcvtDistm3').text(0);
    		...
    		$('#sfrokPavmtBrkgVlme').text(0);
    		$('#gnrlRckPavmtBrkgVlme').text(0);
    		$('#hdrokPavmtBrkgVlme').text(truncate((parseFloat(obj('w2')) * parseFloat(obj('d2')) * (parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4')) + parseFloat(obj('h5')) + parseFloat(obj('h6')) + parseFloat(obj('h7')))),2));
    		$('#hveqEcvtVlme').text(truncate(parseFloat($('#asptPavmtStBrkgVlme').text()) + parseFloat($('#hdrokPavmtBrkgVlme').text()),2));
    		$('#soilHveqEcvtVlme').text(0);
    		$('#hrscEcvtDistm1').text(0);
    		$('#hrscEcvtDistm2').text(0);
    		$('#hrscEcvtDistm3').text(0);
    		...
    		$('#hdrokPavmtBrkgVlme').text(0);
    		//8
    		$('#hveqEcvtVlme').text($('#asptPavmtStBrkgVlme').text());
    		//9
    		$('#soilHveqEcvtVlme').text(truncate(((parseFloat(obj('w1')) + parseFloat(obj('w4'))) / 2) * ((parseFloat(obj('d1')) + parseFloat(obj('d4'))) / 2) * (parseFloat(obj('h2')) + parseFloat(obj('h3')) + parseFloat(obj('h4'))),2));
    		//10
    		$('#hrscEcvtDistm1').text(truncate(((parseFloat(obj('w4')) + parseFloat(obj('w5'))) / 2) * ((parseFloat(obj('d4')) + parseFloat(obj('d5'))) / 2) * parseFloat(obj('h5')),2));
    		//11
    		$('#hrscEcvtDistm2').text(truncate(((parseFloat(obj('w5')) + parseFloat(obj('w7'))) / 2) * ((parseFloat(obj('d5')) + parseFloat(obj('d7'))) / 2) * parseFloat(obj('h6')),2));
    		//12
    		$('#hrscEcvtDistm3').text(truncate(((parseFloat(obj('w7')) + parseFloat(obj('w8'))) / 2) * ((parseFloat(obj('d7')) + parseFloat(obj('d8'))) / 2) * parseFloat(obj('h7')),2));
    	}
    	
    	//14.토사다짐
    	$('#soilCpctRate').text(0);
    	//15.환토다짐
    	$('#resoilCpctVlme').text(truncate((parseFloat(obj('w4')) + parseFloat(obj('w8'))) / 2 * (parseFloat(obj('d4')) + parseFloat(obj('d8'))) / 2 * parseFloat(obj('h12')) - parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h12')), 2));
    	//16.환토비다짐(인력)
    	$('#rsnpRate').text(truncate((parseFloat(obj('w8')) + parseFloat(obj('w8'))) / 2 * (parseFloat(obj('d8')) + parseFloat(obj('d8'))) / 2 * parseFloat(obj('h13')),2));
    	//13.환토
    	$('#resoilVlme').text(truncate(parseFloat($('#resoilCpctVlme').text()) + parseFloat($('#rsnpRate').text()),2));
    	//17.중기잔토처리(사석)
    	$('#rprpHveqEcvtVlme').text(truncate(parseFloat($('#hveqEcvtVlme').text()),2));
    	//18.중기잔토처리(토사)
    	$('#hveqSsopVlme').text(truncate(parseFloat($('#soilHveqEcvtVlme').text()) + parseFloat($('#hrscEcvtDistm1').text()) + parseFloat($('#hrscEcvtDistm2').text()) + parseFloat($('#hrscEcvtDistm3').text()),2));
    	//19.보도걷기
    	$('#pvmtSkimAr').text(0);
    	//20.노면청소
    	$('#stSufcClenAr').text(2);
    	...
    	//22.복구정보 표층
    	$('#rcovSufcHght1').text(truncate(parseFloat(obj('h8')),2));
    	//23.복구정보 기층
    	$('#rcovBaseHght').text(truncate(parseFloat(obj('h9')),2));
    	//24.복구정보 보조기층1
    	if (1 == assiBaseGadtTypeCd && '65' == fcltKndCd) {
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('w3'))) / 2 * (parseFloat(obj('d1')) + parseFloat(obj('d3'))) / 2 * (parseFloat(obj('h2')) + parseFloat(obj('h3'))) - ((parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h3'))) + 0.96 * 0.46 * parseFloat(obj('h2'))),2));
    	} else if (1 == assiBaseGadtTypeCd && '65' != fcltKndCd) {
    		$('#rcovAssiBaseHght1').text(truncate((parseFloat(obj('w1')) + parseFloat(obj('w3'))) / 2 * (parseFloat(obj('d1')) + parseFloat(obj('d3'))) / 2 * (parseFloat(obj('h2')) + parseFloat(obj('h3'))) - ((parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h3'))) + ((1.37/2) * (1.37/2)) * 3.14 * parseFloat(obj('h2'))),2));
    	} else if (1 != assiBaseGadtTypeCd && '65' == fcltKndCd) { 
    		$('#rcovAssiBaseHght1').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')) * (parseFloat(obj('h2')) + parseFloat(obj('h3'))) - (parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h3')) - 0.96 * 0.46 * parseFloat(obj('h2'))),2));
    	} else {
    		$('#rcovAssiBaseHght1').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')) * (parseFloat(obj('h2')) + parseFloat(obj('h3'))) - (parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h3')) - ((1.37/2) * (1.37/2)) * 3.14 * parseFloat(obj('h2'))),2));
    	}
    	//25.복구정보 보조기층2
    	if ('1' == assiBaseGadtAplyEyn) {
    		$('#rcovAssiBaseHght2').text(truncate((parseFloat(obj('w3')) + parseFloat(obj('w4'))) / 2 * (parseFloat(obj('d3')) + parseFloat(obj('d4'))) / 2 * parseFloat(obj('h11')) - ((parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h11')))),2));
    	} else {
    		$('#rcovAssiBaseHght2').text(truncate(parseFloat(obj('w1')) * parseFloat(obj('d1')) * parseFloat(obj('h11')) - (parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(obj('h11'))),2));
    	}
    	//26.구조물체적
    	if ('11' == cdlnMhAryDivCd) {
    		...
    		if ('65' == fcltKndCd) {
    			$('#strceVlme').text(truncate((parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(m.setting(v1RowIndex)['H2'])) - (parseFloat(m.setting(v1RowIndex)['L1']) * parseFloat(m.setting(v1RowIndex)['B1']) * parseFloat(m.setting(v1RowIndex)['H1'])) - (0.96 * 0.46 * 0.15),2));
    		} else {
    			$('#strceVlme').text(truncate((parseFloat(m.setting(v1RowIndex)['L2']) * parseFloat(m.setting(v1RowIndex)['B2']) * parseFloat(m.setting(v1RowIndex)['H2'])) - (parseFloat(m.setting(v1RowIndex)['L1']) * parseFloat(m.setting(v1RowIndex)['B1']) * parseFloat(m.setting(v1RowIndex)['H1'])) - (((1.37/2) * (1.37/2)) * 3.14 * 0.2),2));
    		}
    	}
    	//27.철개 
    	if ('65' == fcltKndCd) {
    ...
    var successCallback = function (response,state,xhr,flag){
    	...
    	if ('combo' == flag) {
			...
			if('U' == obj.flag) {
				...
				//포장층 깊이
				$('select[name=sufcHght]  option:eq(1)').attr('selected','selected');
				$('select[name=sufcHght]').next().text($('select[name=sufcHght]  option:eq(1)').text());
				...
				//동상방지보조기층높이
				$('select[name=fsbtPrvntAssiBaseHght]  option:eq(0)').attr('selected','selected');
				$('select[name=fsbtPrvntAssiBaseHght]').next().text($('select[name=fsbtPrvntAssiBaseHght]  option:eq(0)').text());
				...
				//보조기층(동상방지)직구배적용
				$('select[name=assiBaseGadtAplyEyn]  option:eq(0)').attr('selected','selected');
				$('select[name=assiBaseGadtAplyEyn]').next().text($('select[name=assiBaseGadtAplyEyn]  option:eq(0)').text());
    	...
    	if ('search' == flag) {
    		...
    		$.each($('select[name=fsbtPrvntAssiBaseHght]').children() , function () {
    			$(this).removeAttr('selected');
    			if (this.value == returnData.fsbtPrvntAssiBaseHght) {
    				$(this).attr('selected','selected');
    				$('select[name=fsbtPrvntAssiBaseHght]').next().text($(this).text());
    			}
    		});
    		
    		//delete returnData['fsbtPrvntAssiBaseHght'];
    		
    		$.each($('select[name=gadtRate]').children() , function () {
    			$(this).removeAttr('selected');
    			if (this.value == returnData.gadtRate) {
    				$(this).attr('selected','selected');
    				$('select[name=gadtRate]').next().text($(this).text());
    			}
    		});
    		...
    		$.each($('select[name=assiBaseGadtAplyEyn]').children() , function () {
    			$(this).removeAttr('selected');
    			if (this.value == returnData.assiBaseGadtAplyEyn) {
    				$(this).attr('selected','selected');
    				$('select[name=assiBaseGadtAplyEyn]').next().text($(this).text());
    			}
    		});
    		
    		//delete returnData['assiBaseGadtAplyEyn'];
