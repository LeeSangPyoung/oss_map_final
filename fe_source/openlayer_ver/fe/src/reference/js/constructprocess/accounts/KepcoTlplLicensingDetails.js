/**
 * KepcoTlplLicensingDetails.js
 *
 * @author P096293
 * @date 2016. 7. 20. 오전 17:30:03
 * @version 1.0
 */
$a.page(function() {
  ...
  //Grid 초기화
    var initGrid = function () {
        ...
        //그리드 생성
        $('#'+gridId).alopexGrid({
        	headerGroup: [{fromIndex:0, toIndex:3, title:msgArray['settlementOfAccountsDetails']},{fromIndex:4, toIndex:9, title:msgArray['licensing']+msgArray['dts']}],
    		...
    		columnMapping: [{
				...
				title : msgArray['address'],
				width: '70px'
			}, {
				key : 'beginSect', align:'center',
				title : msgArray['startSection'],
				width: '70px'
			}, {
				key : 'endSect', align:'center',
				title : msgArray['endSection'],
				width: '70px'
			}, {
				key : 'permitNo', align:'center',
				title : msgArray['licensingNumber'],
				width: '70px'
			}, {
				key : 'permitType', align:'center',
				title : msgArray['licensingDivision'],
				width: '80px'
			}, {
				key : 'permit', align:'center',
				title : msgArray['status'],
				width: '70px'
			}],
    ...
    var setGrid = function (page, rowPerPage) {
    	...
    	var url = "tango-transmission-biz/transmission/constructprocess/accounts/kepcoTlplLicensingDetails";
