/**
 * FeeCompareAfterModDetailsGrid.js
 * 설비e대사 DataGrid
 *
 * @author 정중식
 ...
 * @version 1.0
 */
var FeeCompareAfterModDetailsGrid = (function($, Tango, _){
	var options = {};
...
/*		message: {
		...
		columnMapping: [
			...
			{key : 'type', title:'구분'      , width : '90px'},
			{key : 'lastChgDate', title:'수정일'      , width : '90px'},
			{key : 'lastChgUserId', title:'수정자ID'      , width : '90px'},
			...
			{key : 'drtCalcAmt', title:'일할계산액'       , width : '90px'},
			...
			{key : 'nxtEstDivVal', title:'환급환불여부'    , width : '90px'},
			{key : 'nxtEstRsn', title:'환급환불내용'	 , width : '90px'},
...
/*		message: {
		...
		columnMapping: [
						...
						{key : 'nxtEstDivVal', title:'환급환불여부'    , width : '90px'},
						{key : 'nxtEstRsn', title:'환급환불내용'	 , width : '90px'},
						{key : 'etcRmk', title:'요금변경 사유'         ,width : '90px'}
	    ]			
	};
