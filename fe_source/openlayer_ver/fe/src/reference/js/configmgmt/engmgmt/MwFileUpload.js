...
// 		        	form.mwSrno = paramData.mwSrno;
 		        	var data = new FormData(form);
// 		        	data.mwSrno = paramData.mwSrno;


 		        	httpRequest('tango-transmission-biz/transmisson/configmgmt/engmgmt/atflFileUpload', data, 'post', 'uploadFile');
 		        }
		     });
    	});
