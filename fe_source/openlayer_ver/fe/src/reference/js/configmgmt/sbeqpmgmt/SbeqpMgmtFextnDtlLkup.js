/**
 * EpwrStcMgmtFextnRsltReg.js
 *
 * @author Administrator
 * @date 2018. 02. 28.
 * @version 1.0
 */
var sbeqpFextnDtl = $a.page(function() {
    //초기 진입점
	var paramData = null;
	var sbeqpId = null;
    ...
    function setRegDataSet(data) {
    	$(':input','#sbeqpMgmtFextnDtlLkupArea').val('');
    }
    ...
    function setEventListener() {
    	...
    	//장비수정
			...
			var param =  $("#sbeqpMgmtFextnDtlLkupArea").getData();
			param.regYn = "Y";
			...
			var param =  $("#sbeqpMgmtFextnDtlLkupArea").getData();
			param.regYn = "Y";
			$a.navigate('/tango-transmission-web/configmgmt/sbeqpmgmt/SbeqpMgmtFextnInspItmReg.do',param);
        });
    ...
    function successCallback(response, status, jqxhr, flag){
    	if(flag == 'search'){
    		...
    		$('#sbeqpMgmtFextnDtlLkupArea').setData(result);
    	}
    }
    //request 실패시.
