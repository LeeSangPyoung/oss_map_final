 ...
 * @version 1.0
 */
var sbeqpTvssDtl = $a.page(function() {
    //초기 진입점
	var paramData = null;
	var sbeqpId = null;
    ...
    function setRegDataSet(data) {
    	$(':input','#sbeqpMgmtTvssDtlLkupArea').val('');
    }
    ...
    function setEventListener() {
    	...
    	//장비수정
			...
			var param =  $("#sbeqpMgmtTvssDtlLkupArea").getData();
			param.regYn = "Y";
			...
			var param =  $("#sbeqpMgmtTvssDtlLkupArea").getData();
			param.regYn = "Y";
			$a.navigate('/tango-transmission-web/configmgmt/sbeqpmgmt/SbeqpMgmtTvssInspItmReg.do',param);
        });
   	 	//취소
    ...
    function successCallback(response, status, jqxhr, flag){
    	if(flag == 'search'){
    		...
    		if(result == null || result == "" || result == undefined){
	    		...
	    		if(result.exusCbrkInstlYn == 'Y'){
	    			result.exusCbrkInstlYn = "설치";
	    		} else {
	    			result.exusCbrkInstlYn = "미설치";
	    		}
    		}
	    	$('#sbeqpMgmtTvssDtlLkupArea').setData(result);
