 ...
 * @version 1.0
 */
var sbeqpContrDtl = $a.page(function() {
    //초기 진입점
	var paramData = null;
	var sbeqpId = null;
    ...
    function setRegDataSet(data) {
    	$(':input','#sbeqpMgmtContrDtlLkupArea').val('');
    }
    ...
    function setEventListener() {
    	...
    	//장비수정
			...
			var param =  $("#sbeqpMgmtContrDtlLkupArea").getData();
			param.regYn = "Y";
			...
			var param =  $("#sbeqpMgmtContrDtlLkupArea").getData();
			param.regYn = "Y";
			$a.navigate('/tango-transmission-web/configmgmt/sbeqpmgmt/SbeqpMgmtContrInspItmReg.do',param);
        });
   	 	//취소
    ...
    function successCallback(response, status, jqxhr, flag){
    	if(flag == 'search'){
    		...
    		$('#sbeqpMgmtContrDtlLkupArea').setData(result);
    	}
    }
    //request 실패시.
