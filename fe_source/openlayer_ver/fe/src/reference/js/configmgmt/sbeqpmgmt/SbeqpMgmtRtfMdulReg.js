...
var sbeqpRtfMdul = $a.page(function() {
    ...
    this.rtfMdulValChk =  function(){
    	var param =  $("#sbeqpMgmtRtfMdulRegForm").getData();
...
//	 	}
//    	if(param.insVoltVal == ''){
//    		callMsgBox('','I', '필수입력 항목입니다.[ 입력 전압 ]', function(msgId, msgRst){});
//    		return false;
//    	}
//    	if(param.capaVal == ''){
...
//    	return true;
    ...
    this.sbeqpRtfMdulReg = function(data) {
		...
		httpRequest('tango-transmission-biz/transmisson/configmgmt/sbeqpmgmt/mergeSbeqpRtfMdulMgmt', param, 'POST', 'SbeqpRtfMdulReg');
    }
    ...
    function successCallback(response, status, jqxhr, flag){
    	if(flag == 'SbeqpRtfMdulReg') {
    		parent.sbeqp.success();
    	}

    	if(flag == 'SbeqpRtfMdulId') {
        	var param =  $("#sbeqpMgmtRtfMdulRegForm").getData();
        	param.sbeqpId = sbeqpId;
    		httpRequest('tango-transmission-biz/transmisson/configmgmt/sbeqpmgmt/mergeSbeqpRtfMdulMgmt', param, 'POST', 'SbeqpRtfMdulReg');
    	}
    	...
    	if(flag == 'search'){
    		...
    		$('#sbeqpMgmtRtfMdulRegForm').setData(result);
    	}
