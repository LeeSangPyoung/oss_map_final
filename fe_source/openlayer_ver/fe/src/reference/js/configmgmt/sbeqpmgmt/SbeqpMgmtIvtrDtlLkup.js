 ...
 * @version 1.0
 */
var sbeqpIvtrDtl = $a.page(function() {
    //초기 진입점
	var paramData = null;
	var sbeqpId = null;
    ...
    function setRegDataSet(data) {
    	$(':input','#sbeqpMgmtIvtrDtlLkupArea').val('');
    }
    ...
    function setEventListener() {
    	...
    	//장비수정
			...
			var param =  $("#sbeqpMgmtIvtrDtlLkupArea").getData();
			param.regYn = "Y";
			...
			var param =  $("#sbeqpMgmtIvtrDtlLkupArea").getData();
			param.regYn = "Y";
			$a.navigate('/tango-transmission-web/configmgmt/sbeqpmgmt/SbeqpMgmtIvtrInspItmReg.do',param);
        });
   	 	//취소
    ...
    function successCallback(response, status, jqxhr, flag){
    	if(flag == 'search'){
    		...
    		$('#sbeqpMgmtIvtrDtlLkupArea').setData(result);
