 ...
 * @version 1.0
 */
var sbeqpExstrDtl = $a.page(function() {
    //초기 진입점
	var paramData = null;
	var sbeqpId = null;
    ...
    function setRegDataSet(data) {
    	$(':input','#sbeqpMgmtExstrDtlLkupArea').val('');
    }
    ...
    function setEventListener() {
    	...
    	//장비수정
			...
			var param =  $("#sbeqpMgmtExstrDtlLkupArea").getData();
			param.regYn = "Y";
			...
			var param =  $("#sbeqpMgmtExstrDtlLkupArea").getData();
			param.regYn = "Y";
			$a.navigate('/tango-transmission-web/configmgmt/sbeqpmgmt/SbeqpMgmtExstrInspItmReg.do',param);
        });
   	 	//취소
    ...
    function successCallback(response, status, jqxhr, flag){
    	if(flag == 'search'){
    		...
    		if(result == null || result == "" || result == undefined){
	    		...
	    		if(result.rmsAcptStatCd == 'A'){
	    			result.rmsAcptStatCd = "수용";
	    		} else {
	    			result.rmsAcptStatCd = "미수용";
	    		}
    		}
    		$('#sbeqpMgmtExstrDtlLkupArea').setData(result);
