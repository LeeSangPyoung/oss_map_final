 ...
 * @version 1.0
 */
var sbeqpRtfMdulDtl = $a.page(function() {
    //초기 진입점
	var paramData = null;
	var sbeqpId = null;
    ...
    function setRegDataSet(data) {
    	$(':input','#sbeqpMgmtRtfMdulDtlLkupArea').val('');
    }
    ...
    function setEventListener() {
    	...
    	//장비수정
			...
			var param =  $("#sbeqpMgmtRtfMdulDtlLkupArea").getData();
			param.regYn = "Y";
			...
			$a.navigate('/tango-transmission-web/configmgmt/sbeqpmgmt/SbeqpMgmtRtfMdulInspItmReg.do',param);
        });
    ...
    function successCallback(response, status, jqxhr, flag){
    	if(flag == 'search'){
    		...
    		$('#sbeqpMgmtRtfMdulDtlLkupArea').setData(result);
    	}
    }
    //request 실패시.
