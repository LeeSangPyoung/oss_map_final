/**
 * SbeqpMgmtArcnDtlLkup.js
 *
 * @author Administrator
 * @date 2018. 02. 28.
 * @version 1.0
 */
var sbeqpArcnDtl = $a.page(function() {
    //초기 진입점
	var paramData = null;
	var sbeqpId = null;
    ...
    function setRegDataSet(data) {
    	$(':input','#sbeqpMgmtArcnDtlLkupArea').val('');
    }
    ...
    function setEventListener() {
    	...
    	//장비수정
			...
			var param =  $("#sbeqpMgmtArcnDtlLkupArea").getData();
			param.regYn = "Y";
			$a.navigate('/tango-transmission-web/configmgmt/sbeqpmgmt/SbeqpMgmtArcnInspItmReg.do',param);
        });
    ...
    function successCallback(response, status, jqxhr, flag){
    	if(flag == 'search'){
    		...
    		$('#sbeqpMgmtArcnDtlLkupArea').setData(result);
    	}
    }
    //request 실패시.
