...
var pop = $a.page(function() {
    ...
    function initGrid() {
        ...
        $('#'+gridId).alopexGrid({
    		...
    		columnMapping: [
    			...
    			{key : 'eqpCnt', align:'center', title : '장비수', width: '90px'},
    			{key : 'itemCnt', align:'center', title : '상면등록수', width: '90px'},
    			{key : 'barCnt', align:'center', title : '바코드등록수', width: '90px'}],
			message: {/* 데이터가 없습니다. */
	...
	this.setGrid = function(page, rowPerPage){
   	 ...
   	 $('#'+gridId).alopexGrid('showProgress');
		 httpRequest('tango-transmission-biz/transmisson/configmgmt/upsdmgmt/getDrawRegEqpStcCurst', param, 'GET', 'search');
   }
	...
	function successCallback(response, status, jqxhr, flag){
    	...
    	if(flag == 'search'){
    		...
    		pop.setSPGrid(gridId, response, response.drawRegEqpStcCurst);
    	}
    ...
    /*------------------------*
	 ...
	 function btnExportExcelOnDemandClickEventHandler(event){
	        ...
	        var excelFileNm = '장비상면등록현황_'+dayTime;
	   		param.fileName = excelFileNm;
	   		param.fileExtension = "xlsx";
	   		param.excelPageDown = "N";
	   		param.excelUpload = "N";
	   		param.excelMethod = "getDrawRegEqpStcCurst";
	   		param.excelFlag = "getDrawRegEqpStcCurst";
