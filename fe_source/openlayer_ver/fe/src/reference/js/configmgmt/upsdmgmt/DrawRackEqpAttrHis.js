...
var main = $a.page(function() {
    ...
    function setEventListener() {
      ...
      // 	팀을 선택했을 경우
    	 ...
    	 $('#dsbnTab').on('click', function(e) {
    		 location.href = 'UpsdDataMgmtCurst.do';
         });
    ...
    this.setGrid = function(page, rowPerPage){
    	...
    	$('#rowPerPage').val(rowPerPage);
		 ...
		 httpRequest('tango-transmission-biz/transmisson/configmgmt/upsdmgmt/getDUsrHisList', param, 'GET', 'search');
    }
