    ...
    function setEventListener() {
  	 ...
  	 $('#btnSrvcLineCurstLkup').on('click', function(e) {
   	 ...
   	 $('#btnDupMtso').on('click', function(e) {
   		 var param =  $("#mtsoDtlLkupForm").getData();
   		 param.regYn = "Y";
   		 popup('DupMtsoMgmt', $('#ctx').val()+'/configmgmt/common/DupMtsoMgmt.do', configMsgArray['duplicationMobileTelephoneSwitchingMgmt'], param);
        });
...
//   			$a.navigate('/tango-transmission-web/configmgmt/common/MtsoRegPop.do',param);
   			 ...
   			 $a.popup({
   				 popid: 'MtsoReg',
   				 title: configMsgArray['mobileTelephoneSwitchingOfficeUpdate'],
