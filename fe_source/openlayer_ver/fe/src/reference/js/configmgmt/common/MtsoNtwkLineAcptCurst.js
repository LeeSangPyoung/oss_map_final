...
//        	pager : false,
    ...
    function setEventListener() {
    	...
    	//엑셀다운 
    	 $('#btnExportExcel').on('click', function(e) {
    		 ...
    		 param.fileName = '국사네트워크정보';
    		 param.fileExtension = "xlsx";
    		 param.excelPageDown = "N";
    		 param.excelUpload = "N";
    		 param.method = "getMtsoNtwkLineAcptCurstList";
    ...
    function successCallback(response, status, jqxhr, flag){
    	...
    	if(flag == 'search') {
    		...
    		setSPGrid(gridId, response, response.mtsoNtwkLineAcptCurstList);
    	}
    ...
    function setGrid() {
		 ...
		 $('#'+gridId).alopexGrid('showProgress');
		 httpRequest('tango-transmission-biz/transmisson/configmgmt/common/mtsoNtwkLineAcptCurstList', param, 'GET', 'search');
    }
