...
//        	pager : false,
    ...
    function setEventListener() {
    	...
    	//엑셀다운 
    	 $('#btnExportExcel').on('click', function(e) {
    		 ...
    		 param.fileName = 'ERP정보';
    		 param.fileExtension = "xlsx";
    		 param.excelPageDown = "N";
    		 param.excelUpload = "N";
    		 param.method = "getErpAcptCurstList";
    ...
    function successCallback(response, status, jqxhr, flag){
    	...
    	if(flag == 'search') {
    		...
    		setSPGrid(gridId, response, response.erpAcptCurstList);
    	}
    ...
    function setGrid() {
		 ...
		 $('#'+gridId).alopexGrid('showProgress');
		 httpRequest('tango-transmission-biz/transmisson/configmgmt/equipment/erpAcptCurstList', param, 'GET', 'search');
    }
