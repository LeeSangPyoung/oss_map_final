    ...
    function initGrid() {
        ...
        $('#'+gridId).alopexGrid({
    		...
    		columnMapping: [{
				...
				key : 'seqVal', align:'center',
				title : 'SEQ',
				width: '70px'
			}, {/* PCI   	 */
				key : 'pciNo', align:'center',
				title : 'PCI',
				width: '70px'
			}, {/* RU Id       	 */
...
//    	httpRequest('tango-transmission-biz/transmisson/configmgmt/commoncode/group/C00148', null, 'GET', 'eqpRoleDivCd');
    ...
    function setList(param){
    	...
    	if(JSON.stringify(param).length > 2){
        	...
        	httpRequest('tango-transmission-biz/transmisson/configmgmt/common/cifMtsoRu', param, 'GET', 'search');
        }
    }
...
//	             data:[{comCd: "", comCdNm: configMsgArray['all']}]
    	...
    	if(flag == 'search'){
    		...
    		setSPGrid(gridId, response, response.cifMtsoRuList);
    ...
    function gridHide() {
    	...
    	var hideColList = ['eqpRoleDivCd', 'portPveRegIsolYn']; //portPveRegIsolYn추가[20171019]
