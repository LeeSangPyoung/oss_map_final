...
$a.page(function() {
  ...
  //Grid 초기화
    ...
    function gridHide() {
    	...
    	var hideColList = ['eqpInstlMtsoId', 'topMtsoId', 'eqpMdlId', 'eqpId'];
    ...
    function setEventListener() {
    	...
    	//엑셀다운 
    	 $('#btnExportExcel').on('click', function(e) {
    		 ...
    		 param.fileName = "RRS상세정보";
    		 param.fileExtension = "xlsx";
    		 param.excelPageDown = "N";
    		 param.excelUpload = "N";
    		 param.method = "getRrsDtlInfMgmtList";
    ...
    function successCallback(response, status, jqxhr, flag){
    	...
    	if(flag == 'search') {
    		...
    		setSPGrid(gridId, response, response.rrsDtlInfMgmt);
    	}
    ...
    function setGrid(page, rowPerPage) {
    	...
    	$('#rowPerPage').val(rowPerPage);
		 ...
		 httpRequest('tango-transmission-biz/transmisson/configmgmt/etceqpmgmt/rrsDtlInfMgmt', param, 'GET', 'search');
    }
