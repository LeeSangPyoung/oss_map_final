...
//    		$('#portRegArea').clear();
    ...
    function setEventListener() {
	   ...
	   //장비구간현황
	   	 $('#btnEqpSctnCurstLkupReg').on('click', function(e) {
	   		var param =  $("#portRegForm").getData();
	   	...
	   	//변경이력
	   	 $('#btnChgHstReg').on('click', function(e) {
	   		var param =  $("#portRegForm").getData();
	   		 popupList('PortChgHstLkup', $('#ctx').val()+'/configmgmt/portmgmt/PortChgHstLkup.do', '변경이력', param);
	        });
