    ...
    function initGrid() {
        ...
        $('#'+gridId).alopexGrid({
    		...
    		columnMapping: [{
				...
				key : 'sctnRegCnt', align:'center',
				title : configMsgArray['sectionRegistrationCnt'],
				width: '130px'
			}, {/* 대국장비수          */
				key : 'sttEqpCnt', align:'center',
				title : configMsgArray['situationEquipmentCnt'],
				width: '100px'
			}],
			message: {/* 데이터가 없습니다. */
    	...
    	//장비타입 선택시 이벤트
    	 ...
    	 $('#btnExportExcel').on('click', function(e) {
      		//tango transmission biz 모듈을 호출하여야한다.
      		 ...
      		 param.fileName = configMsgArray['equipmentAcceptCurrentState']; /* 장비수용현황     	 */
...
//    	 	popup('EqpDtlLkup', $('#ctx').val()+'/configmgmt/equipment/EqpDtlLkup.do', configMsgArray['equipmentDetailInf'],dataObj);
    ...
    this.setGrid = function(page, rowPerPage){
    	...
    	$('#rowPerPage').val(rowPerPage);
    	 ...
    	 $('#'+gridId).alopexGrid('showProgress');
		 httpRequest('tango-transmission-biz/transmisson/configmgmt/eqpsctnmgmt/eqpSctnAcptCurst', param, 'GET', 'search');
    }
