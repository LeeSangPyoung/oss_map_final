  ...
  //Grid 초기화
    ...
    function setEventListener() {
    	...
    	//엑셀다운 
    	 $('#btnExportExcel').on('click', function(e) {
    		 ...
    		 param.excelUpload = "N";
    		 param.method = "getEqpSctnLineInfLkupList";
    ...
    function successCallback(response, status, jqxhr, flag){
    	...
    	if(flag == 'search') {
    		...
    		setSPGrid(gridId, response, response.EqpSctnLineInfLkup);
    	}
    ...
    function setGrid(page, rowPerPage) {
    	...
    	$('#rowPerPage').val(rowPerPage);
		 ...
		 $('#'+gridId).alopexGrid('showProgress');
		 httpRequest('tango-transmission-biz/transmisson/configmgmt/eqpsctnmgmt/eqpSctnLineInfLkup', param, 'GET', 'search');
    }
