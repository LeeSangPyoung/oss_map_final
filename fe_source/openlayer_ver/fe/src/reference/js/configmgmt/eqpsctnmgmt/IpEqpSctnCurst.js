  ...
  //Grid 초기화
    function initGrid() {
        ...
        $('#'+gridId).alopexGrid({
    		...
    		headerGroup : [ { fromIndex :  3 , toIndex :  7 , title : configMsgArray['west'] , id : "West"},
                  			{ fromIndex : 8 , toIndex : 12 , title : configMsgArray['east'] , id : "East" }],
    		columnMapping: [{
    			/* 순번 			 */
				align:'center',
				...
				key : 'sctnNm', align:'center',
				title : configMsgArray['sectionName'],
				width: '100px'
			}, {/* 장비본부     	 */
				key : 'uprEqpHdofc', align:'center',
				title : configMsgArray['equipmentHeadOffice'],
				width: '100px'
			}, {/* 장비전송실     	 */
				key : 'uprEqpTmof', align:'center',
				title : configMsgArray['equipmentMtso'],
				width: '100px'
			}, {/* 장비국사명     	 */
				key : 'uprEqpMtso', align:'center',
				title : configMsgArray['equipmentMobileTelephoneSwitchingOfficeName'],
				width: '100px'
			}, {/* 장비명         	 */
				key : 'uprEqp', align:'center',
				title : configMsgArray['equipmentName'],
				width: '100px'
			}, {/* 장비포트     	 */
				key : 'uprEqpPort', align:'center',
				title : configMsgArray['equipmentPort'],
				width: '100px'
			}, {/* 장비본부     	 */
				key : 'lowEqpHdofc', align:'center',
				title : configMsgArray['equipmentHeadOffice'],
				width: '100px'
			}, {/* 장비전송실     	 */
				key : 'lowEqpTmof', align:'center',
				title : configMsgArray['equipmentMtso'],
				width: '100px'
			}, {/* 장비국사명     	 */
				key : 'lowEqpMtso', align:'center',
				title : configMsgArray['equipmentMobileTelephoneSwitchingOfficeName'],
				width: '100px'
			}, {/* 장비명       	 */
				key : 'lowEqp', align:'center',
				title : configMsgArray['equipmentName'],
				width: '100px'
			}, {/* 장비포트     	 */
				key : 'lowEqpPort', align:'center',
				title : configMsgArray['equipmentPort'],
				width: '100px'
			}, {/* 등록일자		 */
    ...
    this.setGrid = function(page, rowPerPage){
    	...
    	$('#rowPerPage').val(rowPerPage);
		 ...
		 httpRequest('tango-transmission-biz/transmisson/configmgmt/eqpsctnmgmt/ipEqpSctnCurst', param, 'GET', 'search');
    }
