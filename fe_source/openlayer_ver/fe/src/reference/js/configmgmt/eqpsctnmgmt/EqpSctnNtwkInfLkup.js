  ...
  //Grid 초기화
    function initGrid() {
        ...
        $('#'+gridId).alopexGrid({
    		...
    		columnMapping: [{
				...
				key : 'repNtwkLineNm', align:'center',
				title : '휘더망링',
				width: '200px'
			}, {/* 등록일자		 */
    ...
    function setEventListener() {
    	...
    	//엑셀다운 
    	 $('#btnExportExcel').on('click', function(e) {
    		 ...
    		 param.fileName = "네트워크정보";
    		 param.fileExtension = "xlsx";
    		 param.excelPageDown = "N";
    		 param.excelUpload = "N";
    		 param.method = "getEqpSctnNtwkInfLkupList";
    ...
    function successCallback(response, status, jqxhr, flag){
    	...
    	if(flag == 'search') {
    		...
    		setSPGrid(gridId, response, response.EqpSctnNtwkInfLkup);
    	}
    ...
    function setGrid(page, rowPerPage) {
    	...
    	$('#rowPerPage').val(rowPerPage);
		 ...
		 $('#'+gridId).alopexGrid('showProgress');
		 httpRequest('tango-transmission-biz/transmisson/configmgmt/eqpsctnmgmt/eqpSctnNtwkInfLkup', param, 'GET', 'search');
    }
