	...
	function eqpDtlLkupPop(e, obj){
		...
		eqpPopup('EqpDtlLkup', '/tango-transmission-web/configmgmt/equipment/EqpDtlLkupPop.do', configMsgArray['equipmentDetailInf'], param);
	}
	...
	function portInfMgmtPop(e, obj){
		...
		var eqpId = obj.part.data.eqpId;
		var eqpNm = obj.part.data.name;
		var eqpMdlId = obj.part.data.eqpMdlId;
		var eqpMdlNm = obj.part.data.eqpMdlNm;
		var param = {"eqpId" : eqpId, "eqpNm" : eqpNm, "eqpMdlId" : eqpMdlId, "eqpMdlNm": eqpMdlNm};
		param.dumyPortYn = "N";
		 $a.popup({
