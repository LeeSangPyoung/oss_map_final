...
//    	console.log("paramData : ", paramData);
	...
	function mtsoDtlLkupPop(e, obj){
		console.log("mtsoDtlLkupPop data : ", obj.part.data);
	...
	function sctnDataParsing(sctnData){
		...
		console.log("sctnDataParsing searchData : ", searchData, " || dupchk : ", dupchk);
		console.log("sctnDataParsing sctnData : ", sctnData);
		...
		console.log("sctnDataParsing preveqpid : ", preveqpid);
		console.log("sctnDataParsing nodedata : ", nodedata);
		console.log("sctnDataParsing linkdata : ", linkdata);
...
//    					}
    					...
    					if (svlnSclCdParam != "016" && svlnSclCdParam != "103" && svlnSclCdParam != "030") {
...
//				}
    	...
    	if(flag == "eqpData" || flag == "linkData"){
    		...
    		for(var i=0; i<nodeData.length; i++){
    			...
    			console.log("dupMtsoId : ", dupMtsoId);
    			console.log("dupIntgMtsoId : ", dupIntgMtsoId);
    			...
    			if(resObj.mtsoTypCd == "1"){
					...
					// 서비스 회선
						...
						// 자동 회선일 때 016:LTE, 103:RU회선, 030:5G
						if (searchSvlnSclCd == "016" || searchSvlnSclCd == "103" || searchSvlnSclCd == "030") {
							var chkX = "";
							var chkY = "";
							for(var j=0; j<nodeDataArray.length; j++){
...
//            document.getElementById("lowEqpPop").innerHTML = html;
    ...
    function setTopology(data) {
    	...
    	console.log("intgE2ETopo param : ", param, flag);
