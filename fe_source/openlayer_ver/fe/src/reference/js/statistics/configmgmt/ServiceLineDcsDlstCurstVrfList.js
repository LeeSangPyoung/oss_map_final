...
//			console.log(paramValue);
    ...
    function excelDownload() {
		...
		var worker = new ExcelWorker({
     		excelFileName : cflineMsgArray['dcsDualCollVrfct'],			/* DCS이원화총괄검증 */
     		sheetList: [{
     			sheetName: cflineMsgArray['dcsDualCollVrfct'],			/* DCS이원화총괄검증 */
     			placement: 'vertical',
     			$grid: $('#'+gridId)
     		}]
     	});
	...
	function searchProc(){
    	...
    	cflineShowProgressBody();		
    	httpRequest('tango-transmission-biz/transmisson/statistics/configmgmt/dcsdlst/svlndcsdlstcurstvrflist', param, 'GET', 'searchAllInfo');
    ...
    var getGrid = function() {
			...
			columnMapping: [
		        ...
		        , {key : 'cuidVal'	        	,title : 'CUID' /* CUID */ ,align:'center', width: '80px'}                     
		        , {key : 'mscId'	        	,title : 'MSC' /* MSC */ ,align:'center', width: '80px'}                     
		        , {key : 'bscId'	        	,title : 'BSC' /* BSC */ ,align:'center', width: '80px'}                     
		        , {key : 'btsId'	        	,title : 'BTS' /* BTS */ ,align:'center', width: '80px'}                
		        , {key : 'serviceType'	        	,title : cflineMsgArray['baseMtsoType'] /* 기지국유형 */ ,align:'center', width: '80px'}               
		        , {key : 'impoOrgYn'	        	,title : cflineMsgArray['seriousSmtsoYn'] /* 중요국소유무 */ ,align:'center', width: '100px'}                    
		        , {key : 'leaseCorpDualStat'	        	,title : cflineMsgArray['bizDualostion'] /* 사업자 이원화 */ ,align:'center', width: '100px'}       
		        , {key : 'svlnCnt'	        	,title : cflineMsgArray['lineCount'] /* 회선수 */ ,align:'center', width: '80px'}            
		        , {key : 'dcsDualStat'	        	,title : cflineMsgArray['dcsDualostion'] /* DCS 이원화 */ ,align:'center', width: '90px'}            
		        , {key : 'notDualDcs'	        	,title : cflineMsgArray['notDualostionDcs'] /* 미이원화 DCS */ ,align:'center', width: '100px'}                                                                                   
			]}); 
