...
import { activateSelectMode } from '~/assets/Selection';
...
import { activateAdvancedSelectMode } from '~/assets/Selection';
...
import { activateRectSelectionMode } from '~/assets/Selection';
...
import { activateCircleSelectionMode } from '~/assets/Selection';
...
import { activatePolygonSelectionMode } from '~/assets/Selection';
...
import { clearSelectLayer } from '~/assets/Selection';
clearSelectLayer();
alert('선택된 피처들이 초기화되었습니다.');`;

export const getSelectedFeaturesSample = `// 선택된 피처들 가져오기
import { getSelectedFeatures } from '~/assets/Selection';
