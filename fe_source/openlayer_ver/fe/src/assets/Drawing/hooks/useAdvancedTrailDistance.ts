...
// Advanced Trail Distance 모드 활성화 함수 (MainPage에서 사용)
export const activateAdvancedTrailDistanceMode = (map: any) => {
  console.log('activateAdvancedTrailDistanceMode 함수 시작');
  if (!map) {
  ...
  if (setMeasurementMode) {
    console.log('setMeasurementMode 호출: advanced-trail-distance');
    setMeasurementMode('advanced-trail-distance');
