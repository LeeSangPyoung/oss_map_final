      ...
      <FeatureTypeStyle>       
        ...
        <Rule>
          ...
          <LineSymbolizer>
            ...
            <VendorOption name="stroke-dasharrayUnit">px</VendorOption>            
          </LineSymbolizer>          
        </Rule>
        <VendorOption name="sortBy">zindex A</VendorOption>
        <VendorOption name="sortByGroup">lineGroup</VendorOption>
        </FeatureTypeStyle>
        <FeatureTypeStyle>   
